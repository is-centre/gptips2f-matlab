function gp = frac_02_fun(gp)

%% The function under test: repeated poles in pseudo-rational TF
...
gp.userdata.name = 'Dynamic system identification test with ADFs: FRAC2 case';
