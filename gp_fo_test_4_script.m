% The difference is that here we're using the generalized approach
% hoping that the involved functions act like the "minus" function

% Later note: doesn't work very well! So reverted to original approach

acl;
disp('Running a more difficult FO TF identification task');
disp('using Symbolic Regression through GPTIPS2 package.');
disp(' ');
gp=rungp(@gp_fo_test_4);
